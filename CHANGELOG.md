...
### Unreleased — Domestic supplier GSTIN / PAN
Added optional supplier tax identifiers, reasoned Manager/Admin edits and identifier snapshots in Domestic PO/PDF. Existing orders and calculations preserved.
...
### Domestic supplier addresses — release candidate
Add addresses for new and existing Domestic suppliers with reasoned Manager/Admin edits; display saved supplier address on Domestic PO/PDF. Preserve historical documents and tax details.
...
### Domestic Bill to / Ship to — release candidate
Separate billing and delivery details with Same as Bill to. Supplier address, PIN and mobile on saved PO/PDF; new/existing supplier contact editing. Issued history preserved.
...
### Domestic billing default and purchase contact — release candidate
Prefill supplied Farming Hub company billing on new POs; add manual per-order purchase contact phone and PDF display. Preserve saved billing and issued history.
...
## 2026-09-25 — Domestic PDF layout (DEC-079)
Print-only cleanup: omit supplier code and redundant logo subline; first-page Bill to/Ship to; bordered pictured item table with repeating headings. Existing saved records and on-screen detail unchanged. Publication verification pending.
