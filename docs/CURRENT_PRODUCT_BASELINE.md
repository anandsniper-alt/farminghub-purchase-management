...
> **2026-09-26 reading guide:** this file preserves dated product/release history. Use [Current state](handover/CURRENT_STATE.md) for today's source audit and module classifications, and [the knowledge index](README.md) for ownership. Earlier “live/current/candidate” statements describe their stated dates; latest recorded release is DEC-080/WF-074, not a fresh live check in this audit.
...
## Local candidate — Assembly supplier totals (2026-09-24, DEC-073)
Implemented: Assembly BOM → Compare assembly cost and Price lists → Compare prices → Assembly totals. Compare one saved assembly at a time, selected suppliers and reference supplier; show total INR for one assembly, priced-part coverage, difference/percentage, lowest complete total and photo/quote breakdown. Missing inputs remain incomplete; no BOM repricing or business mutation. Confirmed current composition is required, while unknown saved manual rates do not prevent using valid supplier quotations. This is not historical machine-snapshot costing or PO creation. Verified: 256 native tests and 152 server/review browser checks; see DOMESTIC_ASSEMBLY_COMPARISON_REPORT.md. Not deployed.


## Domestic purchase orders — candidate 2026-09-24 (DEC-074)
Domestic now supports BOM-based vendor PO drafts, automatic FH-LAE-D-PO-n references, selected assembly parts, quantity multiplication, quoted/manual INR rates, required commercial terms, reasoned draft editing, Manager/Admin approval/issue, retained cancellation and pictured Print / Save PDF documents. Executives prepare drafts. Issued snapshots retain the BOM revision and agreed content. Current scope ends at PO issuance; it does not implement Domestic receipts, supplier payments, stock/MRP consumption, GST calculation or ERP push/pull. Those remain later development. Candidate tested locally; live release evidence is recorded in DOMESTIC_PO_RELEASE_REPORT.md.
...
### Local candidate — Domestic supplier GSTIN/PAN (2026-09-24)
Supplier creation supports optional identifiers; Supplier master displays GSTIN/PAN with Manager/Admin reasoned editing. New/re-saved Domestic PO drafts and their PDF include recorded identifiers. Existing issued POs unchanged. Format validation only, no registration lookup. DEC-075/WF-069; not yet live.

Verification: 20 focused native tests and 38 browser checks passed across authenticated server and standalone review modes. Supplier tax edits survive reload; pictured PDFs retain the saved supplier identifiers after master changes. Both builds completed successfully. No live data changed.
...
### Domestic supplier addresses — local candidate, 2026-09-24
Add supplier includes full address. Existing Domestic suppliers have reasoned Manager/Admin Edit address. PO/PDF displays saved address; historical issued records remain unchanged. DEC-076/WF-070.
...
### Domestic Bill to / Ship to — candidate 2026-09-24
Separate billing/shipping details, Same as Bill to, supplier PIN/mobile fields and saved contact details on PDF. Old drafts need billing completion before issue; old issued orders stay unchanged. DEC-077/WF-071.

**Publication verified, 2026-09-24 — DEC-077 / WF-071:** Runtime 01542b99790558cf5462dd0b09403c5e39bb2e73; Coolify wwf3wieav2nexfudfsqusjl2 finished, running:healthy. Bill to/Ship to, Same as Bill to and supplier PIN/mobile snapshots are live. 25 focused native tests, 54 server/review browser checks and 32 read-only live checks passed; PO print layout visually inspected. Fresh 464,930,864-byte recovery ZIP verified by checksum/archive/isolated restore with zero startup business changes. First incomplete download rejected before deployment; counted-stream retry matched exact server size/hash. Five verified ZIPs retained, oldest verified ZIP removed. Workspace revision 1537, accounts, evidence, audit, archives and retry receipts unchanged from backup. No live business writes. Existing issued snapshots remain unchanged; legacy drafts must complete Bill to before issuing. Supersedes candidate status. Private evidence: test-output/domestic-billship-release/; ZIPs: backups/releases/.

### Company billing and order contact — candidate 2026-09-25
New Domestic POs prefill Farming Hub Private Limited Erode billing address/GSTIN and offer manual Purchase contact phone printed on PO/PDF. Existing orders retained. DEC-078/WF-072.

**Publication verified, 2026-09-25 — DEC-078 / WF-072:** Runtime 3eb9aa9a8b99418a7f90449bfe95fb1016b2ad5b; Coolify abnrrmn6e9wibvsksaoah1wx finished, running:healthy. Exact user-supplied company Bill to defaults on new Domestic POs and manual per-order Purchase contact phone are live. 26 focused native tests, 62 final server/review browser checks and 34 read-only live checks passed. Final PDF layout visually inspected after correcting label encoding. Fresh 464,930,345-byte recovery ZIP passed checksum/archive/isolated restore verification; five managed verified ZIPs retained, oldest verified ZIP pruned. Entire workspace revision 1538, accounts, uploaded bodies, audit, archives and retry receipts match the pre-release snapshot. Zero business writes during live verification. Existing saved billing and issued snapshots unchanged. Supersedes candidate status. Private evidence: test-output/domestic-contact-release/; backups: backups/releases/.

2026-09-25, candidate DEC-079: Domestic PO PDF omits supplier code/redundant logo subline, places Bill to / Ship to before items once, and uses a bordered pictured table with repeating headers. Existing order screens and snapshots unchanged. 11 native PO tests and 72 server/review browser checks passed; one-page and four-page PDF checks and visual inspection completed. Release pending backup and live verification.
...
2026-09-25 candidate DEC-080: both mobile numbers visible near top of Domestic PO/PDF. Draft has supplier number defaulted from master and editable per order; existing purchaseContactPhone now labelled Purchase Manager mobile number. Missing values visible as Not recorded. Issued records unchanged; release pending.
...
## 2026-09-26 — Local repair candidate (not published)

DEC-082–084 / WF-076–078 supersede the earlier latest-only VMS reminder behavior and broad conflict description for enumerated Domestic edits. VMS supports direct Record visit, optional next action, all scheduled follow-ups, chronological/outcome history, India dates, multiple offline visits and dirty-page-safe refresh. Shared location text is protected from stale CRM hierarchy IDs. Domestic PO/BOM/address/tax saves guard their actual dependencies; edit tokens are compact and bounded. Native/review build contracts, CI workflow and read-availability health/redacted slow-error logs added.

See [repair report](ENGINEERING_REPAIR_REPORT.md) for current checks and unresolved scope. This is a local candidate; the previous live release record remains authoritative. Storage normalization, paginated workspace loading, complete VMS correction/search/context features, evidence lifecycle, off-site schedule/alerts and production sizing are not completed by this pass.
...
## Local vendor-type and terms-master candidate — 2026-09-26
DEC-086/WF-080 adds typed Supplier/Logistics payment templates and logistics-specific vendor entry/display. Supplier-only production/price-list fields are hidden and disabled for logistics. 17 targeted tests passed; native and review browser checks exercised template creation, selection, type switching, save/reopen and mobile visibility; review build passed. Not published. No cross-order RO loading or void-payment replacement feature is claimed by this change.

**Historical candidate:** DEC-087/WF-081 supersedes this candidate's logistics-template selector and split Payment Terms Master layout. The verification above applies to that earlier implementation, not the following change.

## Direct logistics partner terms — locally verified 2026-09-26
DEC-087/WF-081 follows the user's instruction to enter logistics partner payment terms on the Supplier master screen itself. The revised local candidate uses the existing Add/Edit vendor form with directly editable `logisticsPaymentTerms` for LOGISTICS vendors; Payment Terms Master exposes supplier templates only. Existing typed templates, legacy IDs and recorded data remain for history. No live migration, logistics payable calculation, supplier payment calculation or issued-document change. Native-server and standalone-review browser checks passed for direct entry, type switching, save/list/reopen and mobile display, including absence of the Logistics master section and template selector; review build passed. Not published. The earlier DEC-086 checks remain historical evidence for that candidate.

**Historical control presentation:** DEC-088/WF-082 supersedes only this candidate's unrestricted logistics text field. The verification above describes DEC-087, not the dropdown revision below.

## Logistics payment terms dropdown — local demo candidate, 2026-09-26
DEC-088/WF-082 keeps payment terms on Supplier master → Add/Edit vendor for LOGISTICS and changes the entry control to a dropdown. Choices cover 100% advance, Against logistics invoice, Before cargo/document release, On delivery, 15/30/45/60 days from logistics invoice and Custom terms. Blank remains not recorded; no agreement is selected automatically. Existing text outside the presets opens as Custom unchanged. The selected agreement is saved as the existing `logisticsPaymentTerms` string; no master collection, migration, payable-date calculation or PO/payment rewrite is introduced. Payment Terms Master remains supplier-only. Fresh native-server and standalone-review browser checks passed for initial blank selection, Custom save/reopen, 30-day preset save/reopen, type switching, mobile visibility and absent logistics template/master controls, without JavaScript errors; review build passed. Prior candidate checks remain historical. Not published.

**Historical Custom entry:** DEC-089/WF-083 supersedes only the Custom choice/input above. Those checks describe DEC-088.

## Preset logistics payment terms — local candidate, 2026-09-26
DEC-089/WF-083 removes Custom terms and its free-text input, retaining the eight presets and blank/not recorded in the same Supplier master dropdown. An existing unlisted agreement remains selected as `Recorded: <existing text>` so unrelated edits preserve it; no new custom entry is offered. The existing string field, vendor commands, permissions, reason, revisions and audit remain; no shared-domain change, migration or payable automation. Native-server and standalone-review browser checks passed for absent Custom controls, blank default, preset selection/save/reopen, type switching and mobile display; review build passed. Refreshed demo confirmed eight preset choices for a new Logistics vendor. Not published.

**2026-09-26 DEC-089 extension:** the confirmed LOGISTICS dropdown list adds `90 days from logistics invoice` and `120 days from logistics invoice`, making ten presets. Blank/not recorded, no Custom entry and existing unlisted-agreement preservation remain unchanged. Values are descriptive only, with no automatic follow-ups or payable-date calculation. Not published; earlier verification above applies to the eight-preset candidate.
...
## Manual advance workflow prototype — demo only, 2026-09-26

DEC-090 / WF-084 authorizes an isolated interactive prototype under `prototypes/manual-advance/`, using a synthetic USD 50,000 order and local browser state. It demonstrates Manual PO terms with advance percentage/fixed amount defined during Initial Payment Capture, proposed approval, partial payments, supplier acknowledgement and invoice advance application. Balance terms require an explicit demo choice. Manager/Admin approval, partial-payment policy and balance-term alternatives remain proposals; no production approval policy, financial command, master data or live record is changed. Not published and not authorized for publication. See [Manual advance demo](MANUAL_ADVANCE_DEMO.md) for boundaries, calculations and current verification status.


## Manual advance actual-application preview — LOCAL TRIAL ONLY, 2026-09-26

DEC-091 / WF-085 extends review beyond DEC-090's synthetic prototype: local candidate code integrates Manual into actual Supplier Payment Terms Master, PO, Initial Payment Capture, payment/order guidance and approval views using a fresh copied-data workspace. An isolated new SQLite database and loopback-only server are required; retain captured original JSON unchanged and private data/evidence under ignored storage. Existing orders keep their agreement unless explicitly revised through eligible controlled local workflow; do not mass-convert or rewrite historical payments. No production business writes, live proxy, deployment or production-policy approval. Integrated verification remains pending; see [actual-application preview report](MANUAL_ADVANCE_LIVE_DATA_PREVIEW.md).

## 2026-09-26 — Typed supplier payment terms, local candidate
DEC-092/WF-086 replaces the unpublished Manual advance demo. The actual Supplier Payment Terms Master and PO editor now support percentage/fixed first and second advances with final balance; existing payment capture/receipt/void workflows are reused. Full native suite: 307 passed; native and standalone browser save/reopen and mobile checks passed. See VALUE_PAYMENT_TERMS.md. No production data conversion, push or deployment. Historical DEC-090/091 results describe the superseded candidate only.

## 2026-09-26 — Combined RO and correction release candidate
DEC-093/WF-087 completes partial cross-order/multi-supplier RO allocation, pending item filters and linked void-payment replacement. DEC-092 fixed-value terms is included under the current publication request; the discarded Manual prototype remains excluded. Full suite 314 passed before final input/filter refinement; focused seven tests and review build passed after it. Native/review browser checks passed. See RO_LOADING_AND_PAYMENT_CORRECTIONS.md for exact scope/limits; publication and backup verification still pending. The read-only live runtime remains 602af7d at revision1584; no business records were changed.
